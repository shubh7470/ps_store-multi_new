                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-[#a41212]/30 text-[#a41212]">
                    <div className="max-w-md">
                        <div className="flex-shrink-0 w-48">
                            <Link href="/" className="relative text-3xl lg:text-4xl font-semibold text-slate-700 inline-block">
                                <span className="text-[#e50029]">go</span>
                                <span className="text-[#a41212]">cart</span>
                                <span className="text-[#e50029] text-4xl lg:text-5xl leading-0">.</span>
                                <span className="absolute text-[10px] lg:text-xs font-semibold -top-1 left-full ml-1 px-2 lg:px-3 py-0.5 rounded-full text-white bg-[#e50029] whitespace-nowrap">
                                    plus
                                </span>
                            </Link>
                        </div>
